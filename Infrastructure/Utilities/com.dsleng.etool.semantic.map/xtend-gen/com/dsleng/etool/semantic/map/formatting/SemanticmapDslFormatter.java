 ...
 * generated by Xtext
 */
package com.dsleng.etool.semantic.map.formatting;
...
public class SemanticmapDslFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private SemanticmapDslGrammarAccess _semanticmapDslGrammarAccess;
  
  @Override
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._semanticmapDslGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._semanticmapDslGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._semanticmapDslGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._semanticmapDslGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._semanticmapDslGrammarAccess.getML_COMMENTRule();
