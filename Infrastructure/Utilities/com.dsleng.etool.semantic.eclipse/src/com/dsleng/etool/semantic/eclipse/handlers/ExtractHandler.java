...
import com.dsleng.etool.semantic.map.SemanticmapDslStandaloneSetup;
...
public class ExtractHandler extends AbstractHandler {
	...
	private void createEcore(IFile input){
		Injector injector = new SemanticmapDslStandaloneSetup().createInjectorAndDoEMFRegistration();
		...
		fileName = fileName.replace(".smp", ".smp.xmi");
