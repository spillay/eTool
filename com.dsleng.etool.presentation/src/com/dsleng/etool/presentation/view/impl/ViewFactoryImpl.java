...
public class ViewFactoryImpl extends EFactoryImpl implements ViewFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ViewPackage.LAYERS: return (EObject)createLayers();
			case ViewPackage.HORIZONTAL: return (EObject)createHorizontal();
			case ViewPackage.VERTICAL: return (EObject)createVertical();
			case ViewPackage.CONTENT: return (EObject)createContent();
			case ViewPackage.PAGE: return (EObject)createPage();
			default:
