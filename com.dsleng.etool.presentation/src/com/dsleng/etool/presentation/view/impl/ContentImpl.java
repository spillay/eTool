...
public class ContentImpl extends LayersImpl implements Content {
	...
	public void setHeight(int newHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.CONTENT__HEIGHT, oldHeight, height));
	}
	...
	public void setWidth(int newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.CONTENT__WIDTH, oldWidth, width));
	}
