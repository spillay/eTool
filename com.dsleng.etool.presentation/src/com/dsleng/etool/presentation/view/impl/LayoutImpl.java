...
public class LayoutImpl extends MinimalEObjectImpl.Container implements Layout {
	...
	public EList<Layers> getLayers() {
		if (layers == null) {
			layers = new EObjectContainmentEList<Layers>(Layers.class, this, ViewPackage.LAYOUT__LAYERS);
		}
		return layers;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ViewPackage.LAYOUT__LAYERS:
				getLayers().clear();
				getLayers().addAll((Collection<? extends Layers>)newValue);
				return;
		}
