 ...
 * </p>
 * <ul>
 *   <li>{@link com.dsleng.etool.model.bobjs.impl.BusinessObjectImpl#getReferences <em>References</em>}</li>
 *   <li>{@link com.dsleng.etool.model.bobjs.impl.BusinessObjectImpl#getSuperTypes <em>Super Types</em>}</li>
 *   <li>{@link com.dsleng.etool.model.bobjs.impl.BusinessObjectImpl#getEnums <em>Enums</em>}</li>
 *   <li>{@link com.dsleng.etool.model.bobjs.impl.BusinessObjectImpl#getBasedon <em>Basedon</em>}</li>
 *   <li>{@link com.dsleng.etool.model.bobjs.impl.BusinessObjectImpl#getOperations <em>Operations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BusinessObjectImpl extends BusinessTypeImpl implements BusinessObject {
	 ...
	 * @ordered
	 */
	protected EList<com.dsleng.etool.model.bobjs.Enum> enums;
	 ...
	 * @generated
	 */
	public EList<com.dsleng.etool.model.bobjs.Enum> getEnums() {
		if (enums == null) {
			enums = new EObjectContainmentEList<com.dsleng.etool.model.bobjs.Enum>(com.dsleng.etool.model.bobjs.Enum.class, this, BobjsPackage.BUSINESS_OBJECT__ENUMS);
		}
		return enums;
	}
	...
	public EList<Operation> getOperations() {
		if (operations == null) {
			operations = new EObjectContainmentEList<Operation>(Operation.class, this, BobjsPackage.BUSINESS_OBJECT__OPERATIONS);
		}
		return operations;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case BobjsPackage.BUSINESS_OBJECT__OPERATIONS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case BobjsPackage.BUSINESS_OBJECT__ENUMS:
				getEnums().clear();
				getEnums().addAll((Collection<? extends com.dsleng.etool.model.bobjs.Enum>)newValue);
				return;
			case BobjsPackage.BUSINESS_OBJECT__BASEDON:
				getBasedon().clear();
