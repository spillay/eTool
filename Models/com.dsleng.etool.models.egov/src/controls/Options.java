 ...
 * </p>
 * <ul>
 *   <li>{@link controls.Options#getName <em>Name</em>}</li>
 *   <li>{@link controls.Options#getValueplaceholder <em>Valueplaceholder</em>}</li>
 * </ul>
 *
 * @see controls.ControlsPackage#getOptions()
 * @model
 * @generated
 */
public interface Options extends EObject {
	 ...
	 * @see #setName(String)
	 * @see controls.ControlsPackage#getOptions_Name()
	 * @model required="true"
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link controls.Options#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see controls.ControlsPackage#getOptions_Valueplaceholder()
