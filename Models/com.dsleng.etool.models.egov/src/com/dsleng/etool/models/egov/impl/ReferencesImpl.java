 ...
 * </p>
 * <ul>
 *   <li>{@link com.dsleng.etool.models.egov.impl.ReferencesImpl#getBusinessobject <em>Businessobject</em>}</li>
 *   <li>{@link com.dsleng.etool.models.egov.impl.ReferencesImpl#getInclusion <em>Inclusion</em>}</li>
 *   <li>{@link com.dsleng.etool.models.egov.impl.ReferencesImpl#getMultiplicity <em>Multiplicity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferencesImpl extends MinimalEObjectImpl.Container implements References {
	...
	protected EClass eStaticClass() {
		return EgovPackage.Literals.REFERENCES;
	}
		...
		if (businessobject != null && businessobject.eIsProxy()) {
			...
			if (businessobject != oldBusinessobject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EgovPackage.REFERENCES__BUSINESSOBJECT, oldBusinessobject, businessobject));
			}
		}
	...
	public void setBusinessobject(BusinessObject newBusinessobject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EgovPackage.REFERENCES__BUSINESSOBJECT, oldBusinessobject, businessobject));
	}
	...
	public void setInclusion(Inclusions newInclusion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EgovPackage.REFERENCES__INCLUSION, oldInclusion, inclusion));
	}
	...
	public void setMultiplicity(Multiplicity newMultiplicity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EgovPackage.REFERENCES__MULTIPLICITY, oldMultiplicity, multiplicity));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EgovPackage.REFERENCES__BUSINESSOBJECT:
				if (resolve) return getBusinessobject();
				return basicGetBusinessobject();
			case EgovPackage.REFERENCES__INCLUSION:
				return getInclusion();
			case EgovPackage.REFERENCES__MULTIPLICITY:
