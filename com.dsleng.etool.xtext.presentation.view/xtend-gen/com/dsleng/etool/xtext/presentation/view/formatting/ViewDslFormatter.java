 ...
 * generated by Xtext
 */
package com.dsleng.etool.xtext.presentation.view.formatting;
...
public class ViewDslFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private ViewDslGrammarAccess _viewDslGrammarAccess;
  
  @Override
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._viewDslGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._viewDslGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._viewDslGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._viewDslGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._viewDslGrammarAccess.getML_COMMENTRule();
