...
/**
 * This is the item provider adapter for a {@link com.dsleng.etool.presentation.view.Layout} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LayoutItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ViewPackage.Literals.LAYOUT__LAYERS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Layout.class)) {
			case ViewPackage.LAYOUT__LAYERS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ViewPackage.Literals.LAYOUT__LAYERS,
				 ViewFactory.eINSTANCE.createLayers()));

		newChildDescriptors.add
			(createChildParameter
				(ViewPackage.Literals.LAYOUT__LAYERS,
				 ViewFactory.eINSTANCE.createHorizontal()));

		newChildDescriptors.add
			(createChildParameter
				(ViewPackage.Literals.LAYOUT__LAYERS,
				 ViewFactory.eINSTANCE.createVertical()));

		newChildDescriptors.add
			(createChildParameter
				(ViewPackage.Literals.LAYOUT__LAYERS,
				 ViewFactory.eINSTANCE.createContent()));
	}
