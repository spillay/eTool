...
public class ViewFactoryImpl extends EFactoryImpl implements ViewFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ViewPackage.LAYOUT: return createLayout();
			case ViewPackage.LAYERS: return createLayers();
			case ViewPackage.HORIZONTAL: return createHorizontal();
			case ViewPackage.VERTICAL: return createVertical();
			case ViewPackage.CONTENT: return createContent();
			case ViewPackage.PAGE: return createPage();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case ViewPackage.LAYOUT_POSITION:
				return createLayoutPositionFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case ViewPackage.LAYOUT_POSITION:
				return convertLayoutPositionToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public LayoutPosition createLayoutPositionFromString(EDataType eDataType, String initialValue) {
		LayoutPosition result = LayoutPosition.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertLayoutPositionToString(EDataType eDataType, Object instanceValue) {
